/*******************************************************************************
Description: 	Merge all files together and create final variables/dataset
...
merge m:1 isic3_3d year using "$workingfolder\digitalization_clean.dta", keep(1 3) nogen
